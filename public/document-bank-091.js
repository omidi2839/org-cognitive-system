...
async function runBankSearch(){
 ...
 try{
   ...
   if(count)count.textContent=`${toFa(d.summary?.visible||0)} سند قابل مشاهده`;
...
/*
 Hotfix 0.9.1.2:
 - Never observe characterData; Persian digit replacement must not recursively
   trigger the observer.
 - Coalesce bursts of structural DOM changes into one animation-frame pass.
*/
