...
const scripts=[
 ...
 './document-relations-ui-0944.js?v=0.9.4.4',`./document-meeting-command-09582.js?v=${VERSION}`,`./knowledge-governance-0980.js?v=${VERSION}`,`./platform-unified-09889.js?v=${VERSION}`
];
function mount(){
